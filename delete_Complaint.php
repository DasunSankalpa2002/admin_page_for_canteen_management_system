...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "DELETE FROM user_complaint WHERE complaint_id = $item_id";
...
<div class="container">
    ...
    <form method="POST"
          action="delete_complaint.php?id=<?php echo $item_id; ?>"
